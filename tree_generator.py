...
class TreeGenerator:
    ...
    #             if index == folders_count-1 and files_count == 0:  # this folder is last folder
    #                 self._get_tree_list(f'{folder}/{content}', depth+1, last_folder_list+[True])
                
    #             else:
    #                 self._get_tree_list(f'{folder}/{content}', depth+1, last_folder_list+[False])
